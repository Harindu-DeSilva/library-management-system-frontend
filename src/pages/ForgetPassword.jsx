...
import {  sendVerificationCodeApi, verifyVerificationCodeApi } from "../api/authApi";
...
export default function ForgetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await verifyVerificationCodeApi({
        providedCode,
        email,
        newPassword
      });
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl border border-slate-100 overflow-hidden">
          ...
          <div className="p-10">
            ...
            <div className="flex flex-col items-center mb-10">
              ...
              <h1 className="text-3xl font-bold">Check Your Email for Code.</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               {/* verify code */}
              <div>
                <label className="text-sm font-bold ml-1">Verification Code</label>
